...
# No option mark AND no underlying spot for this long → UNPROTECTED CRITICAL.
MARK_BLACKOUT_MINUTES = _env_int("MARK_BLACKOUT_MINUTES", 45)
...
def log_risk_config() -> None:
    ...
    print(
        ...
        f"MARK_BLACKOUT_MINUTES={MARK_BLACKOUT_MINUTES}"
    )
